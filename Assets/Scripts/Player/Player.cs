...
public class Player : MonoBehaviour
{
    ...
    private void MovePlayer()
    {
        ...
        // Animation -
        // We want to move the player in world space, but we also want the character model to always either face the mouse position or to face an enemy target when
        // auto-attacking
